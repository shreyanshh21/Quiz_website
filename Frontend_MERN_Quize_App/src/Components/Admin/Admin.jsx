    ...
    <div>
      <div className="md:w-11/12 mx-auto bg-gray-100/10 flex p-4 my-6 mt-24">
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            <p className="text-lg text-black-100 leading-loose">
              A Full Stack Web Developer 🚀 from Bihar, India, currently 💻 I'm
              doing my Full Stack Development from LPU. I am passionate
              about technology and want to learn & explore new technologies.
            </p>
          </div>
        ...
        <div className="w-5/12 p-16 ml-24">
          <img
            src="C:\Users\shrey\OneDrive\Desktop\dms\20240127_153643.jpg"
            alt="admin"
