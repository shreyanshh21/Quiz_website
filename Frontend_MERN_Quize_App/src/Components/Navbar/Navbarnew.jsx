...
export const Navbarnew = () => {
  ...
  const logouthandler = () => {
    ...
    if (adminName == "Arvind Singh Chouhan") {
      toast(`Arvind Singh Successfully Logout `, {
        type: "success",
      });
      dispatch(Logouthandleraction());
    }
  ...
  return (
    <div className="w-11/12 h-24 m-auto flex bg-purple-00 mb-8 " >
      ...
      <div className="w-2/5 ml-14 ">
        {/* <img className="w-96 h-24" src="./MERN1.png" alt="" /> */}
